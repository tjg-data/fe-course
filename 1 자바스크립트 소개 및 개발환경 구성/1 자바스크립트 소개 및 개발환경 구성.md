...
- 리스트(list) : 데이터를 연속적으로 관리한다. 값을 바꿀 수 있다.
- 튜플(tuple) : 데이터를 연속적으로 관리한다. 값을 바꿀 수 없다.
- 세트(set) : 집합과 같은 속성을 갖는다.
- 딕셔너리 : key-value 쌍을 갖는다.
</aside>
...
- 터미널에서 버전 확인
    ...
    ![image.png](b3cd9a33-c854-4a3e-b78f-f559e69ce06f.png)
